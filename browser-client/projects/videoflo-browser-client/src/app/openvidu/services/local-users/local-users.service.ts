...
export class LocalUsersService {
  ...
  private _screenShareState = <BehaviorSubject<boolean>>(
    new BehaviorSubject(false)
  );
  private _webcamVideoActive = <BehaviorSubject<boolean>>(
  ...
  initialize() {
    ...
    this.nickname = this.activitiesService.participantName;
    this.data = {
      participantId: this.activitiesService.participantId,
      externalParticipantId: this.activitiesService.externalParticipantId,
      name: this.activitiesService.participantName,
      role: this.activitiesService.participantRole,
    };

    this.webcamUser = new UserModel(null, null, this.nickname, this.data);
