...
export class AppModule {
  constructor(private injector: Injector) {
    const strategyFactory = new ElementZoneStrategyFactory(VideofloComponent, this.injector);
    const element = createCustomElement(VideofloComponent, { injector: this.injector, strategyFactory });
    customElements.define('videoflo-webcomponent', element);
  }
